...
export default function Story() {
  ...
  return (
    <section
      id="story"
      className="bg-paper-2 px-gutter py-section-y min-h-svh max-md:min-h-0 max-md:py-[88px] relative overflow-hidden"
    >
      <div className="max-w-container mx-auto relative">
        <Reveal
          as="h2"
          className="text-fluid-h2 max-md:text-fluid-mobile-h2 font-medium leading-[1.16] tracking-snug m-0 mb-20 max-md:mb-11 max-w-container-narrow mx-auto text-center"
          delay={120}
          dangerouslySetInnerHTML={{ __html: t('story.title') }}
        />

        <div className="grid grid-cols-2 max-md:grid-cols-1 gap-8 mb-24">
          <Reveal
